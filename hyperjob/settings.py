...
TEMPLATES = [
    {
        ...
        'DIRS': [
            # template per app
            os.path.join(BASE_DIR, 'resume/resume/templates'),
            os.path.join(BASE_DIR, 'vacancy/vacancy/templates'),

            os.path.join(BASE_DIR, 'user_login/user_login/templates'),
            os.path.join(BASE_DIR, 'user_signup/user_signup/templates'),
            os.path.join(BASE_DIR, 'user_logout/user_logout/templates'),

            os.path.join(BASE_DIR, 'home/home/templates'),
